 ...
 * 
 */
@WebServiceClient(name = "EpServiceService", targetNamespace = "http://webservice.export.itcast.cn/", wsdlLocation = "http://localhost:8080/jkexportserver/ws/export?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/jkexportserver/ws/export?wsdl");
