...
public class ExtCproduct {
    ...
    private ContractProducts contractProduct = new ContractProducts();
    ...
    public ContractProducts getContractProduct() {
        return contractProduct;
    }

    public void setContractProduct(ContractProducts contractProduct) {
